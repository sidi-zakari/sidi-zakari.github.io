...
const PORTFOLIO_DATA = {
  ...
  fr: {
      ...
      items: [
        {
          ...
          period: "2023",
          place: "Parakou, Bénin",
          file: "certificats/diplome-licence-sociologie-anthropologie-2023.pdf"
        }
      ]
    },
    ...
    certifications: {
      ...
      items: [
        { name: "Certificat d'appréciation — Appui à la Campagne Génération Sans Tabac", org: "VNU / OMS", year: "2026", file: "certificats/vnu-oms-generation-sans-tabac-2026.pdf" },
        { name: "Certificat d'appréciation — Soutien à la Journée mondiale des réfugiés", org: "VNU / HCR", year: "2026", file: "certificats/vnu-unhcr-journee-mondiale-refugies-2026.pdf" },
        { name: "Suivi & Évaluation — Programmes de retour et de réintégration", org: "OIM E-Campus", year: "2026", file: "certificats/se-oim-retour-reintegration-2026.pdf" },
        { name: "MEAL — Suivi, évaluation, redevabilité et apprentissage en situations d'urgence", org: "Save the Children / DisasterReady", year: "2026", file: "certificats/meal-savethechildren-disasterready-2026.pdf" },
        { name: "Fondamentaux de la gestion de projet", org: "DisasterReady / Cornerstone OnDemand", year: "2026", file: "certificats/gestion-de-projet-disasterready-2026.pdf" },
        { name: "Marketing Digital", org: "FORCE-N", year: "2026", file: "certificats/marketing-digital-force-n-2026.pdf" },
        { name: "Éducation Transformatrice de Genre", org: "UNICEF / UNGEI / Transform Education / Plan International", year: "2026", file: "certificats/education-transformatrice-genre-unicef-ungei-2026.pdf" },
        { name: "Manipulation, stockage et gestion des données", org: "UNICEF / Global Nutrition Cluster", year: "2024", file: "certificats/gestion-donnees-unicef-agora-2024.pdf" },
        { name: "Planification de la collecte, du traitement et de l'analyse des données", org: "UNICEF (Agora)", year: "2024", file: "certificats/collecte-traitement-analyse-donnees-unicef-agora-2024.pdf" },
        { name: "Collecte de données primaires", org: "UNICEF (Agora)", year: "2024", file: "certificats/collecte-donnees-primaires-unicef-agora-2024.pdf" },
        { name: "Programmation sensible aux conflits et à la consolidation de la paix", org: "UNICEF (Agora)", year: "2024", file: "certificats/conflit-paix-programmation-unicef-agora-2024.pdf" },
        { name: "Mobilisation RH pour la nutrition en contextes humanitaires", org: "UNICEF / Global Nutrition Cluster", year: "2024", file: "certificats/nutrition-humanitaire-rh-unicef-agora-2024.pdf" },
        { name: "Atténuation des risques de VBG dans la coordination humanitaire", org: "UNICEF (Agora)", year: "2024", file: "certificats/vbg-coordination-humanitaire-unicef-agora-2024.pdf" },
  ...
  en: {
    ...
    certifications: {
      ...
      items: [
        { name: "Certificate of Appreciation — Supporting the Generation Smoke-Free Campaign", org: "UNV / WHO", year: "2026", file: "certificats/vnu-oms-generation-sans-tabac-2026.pdf" },
        { name: "Certificate of Appreciation — Supporting World Refugee Day", org: "UNV / UNHCR", year: "2026", file: "certificats/vnu-unhcr-journee-mondiale-refugies-2026.pdf" },
        { name: "Monitoring & Evaluation — Return and Reintegration Programmes", org: "IOM E-Campus", year: "2026", file: "certificats/se-oim-retour-reintegration-2026.pdf" },
        { name: "MEAL — Monitoring, Evaluation, Accountability and Learning in Emergencies", org: "Save the Children / DisasterReady", year: "2026", file: "certificats/meal-savethechildren-disasterready-2026.pdf" },
        { name: "Project Management Fundamentals", org: "DisasterReady / Cornerstone OnDemand", year: "2026", file: "certificats/gestion-de-projet-disasterready-2026.pdf" },
        { name: "Digital Marketing", org: "FORCE-N", year: "2026", file: "certificats/marketing-digital-force-n-2026.pdf" },
        { name: "Gender-Transformative Education", org: "UNICEF / UNGEI / Transform Education / Plan International", year: "2026", file: "certificats/education-transformatrice-genre-unicef-ungei-2026.pdf" },
        { name: "Data Handling, Storage and Management", org: "UNICEF / Global Nutrition Cluster", year: "2024", file: "certificats/gestion-donnees-unicef-agora-2024.pdf" },
        { name: "Planning Data Collection, Processing and Analysis", org: "UNICEF (Agora)", year: "2024", file: "certificats/collecte-traitement-analyse-donnees-unicef-agora-2024.pdf" },
        { name: "Primary Data Collection", org: "UNICEF (Agora)", year: "2024", file: "certificats/collecte-donnees-primaires-unicef-agora-2024.pdf" },
        { name: "Conflict-Sensitive and Peacebuilding Programming", org: "UNICEF (Agora)", year: "2024", file: "certificats/conflit-paix-programmation-unicef-agora-2024.pdf" },
        { name: "HR Mobilisation for Nutrition in Humanitarian Contexts", org: "UNICEF / Global Nutrition Cluster", year: "2024", file: "certificats/nutrition-humanitaire-rh-unicef-agora-2024.pdf" },
        { name: "GBV Risk Mitigation in Humanitarian Coordination", org: "UNICEF (Agora)", year: "2024", file: "certificats/vbg-coordination-humanitaire-unicef-agora-2024.pdf" },
